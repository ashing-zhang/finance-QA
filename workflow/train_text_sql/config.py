...
class Config:
    seed = 42
    model_name = "../models/Tongyi-Finance-14B-Chat"    # lora微调该模型
    train_data_dir = "../text2sql_dataset_generator"
    train_json_path = "train_text_sql.json"
    # train_json_path = "train_text_sql_add.json"
    val_data_dir = "../text2sql_dataset_generator"
    val_json_path = "val_text_sql.json"
    # val_json_path = "val_text_sql_add.json"
    test_data_dir = "../text2sql_dataset_generator"
    test_json_path = "test_text_sql.json"
    sql_model_save_path = "./model_save/sql_lora"
    epochs = 5  # 最大epoch数
